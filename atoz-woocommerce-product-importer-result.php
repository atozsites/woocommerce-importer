...
<script type="text/javascript">
    jQuery(document).ready(function($){
        ...
        function doAjaxImport(limit, offset) {
            var data = {
                "action": "atoz-woocommerce-product-importer-ajax",
...
<div class="woo_product_importer_wrapper wrap">
    ...
    <h2><?php _e( 'Woo Product Importer &raquo; Results', 'atoz-woocommerce-product-importer' ); ?></h2>
    ...
    <div id="import_status">
        <div id="import_in_progress">
            <img src="<?php echo plugin_dir_url(__FILE__); ?>img/ajax-loader.gif"
                alt="<?php _e( 'Importing. Please do not close this window or click your browser\'s stop button.', 'atoz-woocommerce-product-importer' ); ?>"
                title="<?php _e( 'Importing. Please do not close this window or click your browser\'s stop button.', 'atoz-woocommerce-product-importer' ); ?>">

            <strong><?php _e( 'Importing. Please do not close this window or click your browser\'s stop button.', 'atoz-woocommerce-product-importer' ); ?></strong>
        </div>
        <div id="import_complete">
            <img src="<?php echo plugin_dir_url(__FILE__); ?>img/complete.png"
                alt="<?php _e( 'Import complete!', 'atoz-woocommerce-product-importer' ); ?>"
                title="<?php _e( 'Import complete!', 'atoz-woocommerce-product-importer' ); ?>">
            <strong><?php _e( 'Import Complete! Results below.', 'atoz-woocommerce-product-importer' ); ?></strong>
        </div>

        <table>
            <tbody>
                <tr>
                    <th><?php _e( 'Processed', 'atoz-woocommerce-product-importer' ); ?></th>
                    <td id="insert_count">0</td>
                </tr>
                <tr>
                    <th><?php _e( 'Remainin', 'atoz-woocommerce-product-importer' ); ?>g</th>
                    <td id="remaining_count"><?php echo $post_data['row_count']; ?></td>
                </tr>
                <tr>
                    <th><?php _e( 'Total', 'atoz-woocommerce-product-importer' ); ?></th>
    ...
    <table id="inserted_rows" class="wp-list-table widefat fixed pages" cellspacing="0">
        <thead>
            <tr>
                ...
                <th style="width: 80px;"><?php _e( 'CSV Row', 'atoz-woocommerce-product-importer' ); ?></th>
                <th style="width: 80px;"><?php _e( 'New Post ID', 'atoz-woocommerce-product-importer' ); ?></th>
                <th><?php _e( 'Name', 'atoz-woocommerce-product-importer' ); ?></th>
                <th><?php _e( 'SKU', 'atoz-woocommerce-product-importer' ); ?></th>
                <th style="width: 120px;"><?php _e( 'Price', 'atoz-woocommerce-product-importer' ); ?></th>
                <th><?php _e( 'Result', 'atoz-woocommerce-product-importer' ); ?></th>
            </tr>
        </thead>
        <tbody><!-- rows inserted via AJAX --></tbody>
    </table>

    <p><a id="show_debug" href="#" class="button"><?php _e( 'Show Raw AJAX Responses', 'atoz-woocommerce-product-importer' ); ?></a></p>
