<?php 
    ...
    if(isset($_POST['import_csv_url']) && strlen($_POST['import_csv_url']) > 0) {
        ...
        if(!file_exists($upload_dir)) {
            $error_messages[] = sprintf( __( 'Could not create upload directory %s.', 'atoz-woocommerce-product-importer' ), $upload_dir );
        }
        ...
        if($uploaded_file_ext != 'csv') {
            $error_messages[] = sprintf( __( 'The file extension %s is not allowed.', 'atoz-woocommerce-product-importer' ), $uploaded_file_ext );
            ...
            if(move_uploaded_file($_FILES['import_csv']['tmp_name'], $uploaded_file_path)) {
                ...
                $error_messages[] = sprintf( __( '%s returned false.', 'atoz-woocommerce-product-importer' ), '<code>' . move_uploaded_file() . '</code>' );
            }
        }
    }
    ...
    if($file_path) {
        ...
        if ( $handle !== FALSE ) {
            ...
            $error_messages[] = __( 'Could not open file.', 'atoz-woocommerce-product-importer' );
        }
        ...
        if($row_count == 0)
            $error_messages[] = __( 'No data to import.', 'atoz-woocommerce-product-importer' );
    ...
    $col_mapping_options = array(
        ...
        'do_not_import' => array(
            'label' => __( 'Do Not Import', 'atoz-woocommerce-product-importer' ),
            'mapping_hints' => array()),
        ...
        'post_title' => array(
            'label' => __( 'Name', 'atoz-woocommerce-product-importer' ),
            'mapping_hints' => array('title', 'product name')),
        '_sku' => array(
            'label' => __( 'SKU', 'atoz-woocommerce-product-importer' ),
            'mapping_hints' => array()),
        'post_content' => array(
            'label' => __( 'Description', 'atoz-woocommerce-product-importer' ),
            'mapping_hints' => array('desc', 'content')),
        'post_excerpt' => array(
            'label' => __( 'Short Description', 'atoz-woocommerce-product-importer' ),
        ...
        'post_status' => array(
            'label' => __( 'Status (Valid: publish/draft/trash/[more in Codex])', 'atoz-woocommerce-product-importer' ),
            'mapping_hints' => array('status', 'product status', 'post status')),
        'menu_order' => array(
            'label' => __( 'Menu Order', 'atoz-woocommerce-product-importer' ),
            'mapping_hints' => array('menu order')),
        '_visibility' => array(
            'label' => __( 'Visibility (Valid: visible/catalog/search/hidden)', 'atoz-woocommerce-product-importer' ),
            'mapping_hints' => array('visibility', 'visible')),
        '_featured' => array(
            'label' => __( 'Featured (Valid: yes/no)', 'atoz-woocommerce-product-importer' ),
            'mapping_hints' => array('featured')),
        '_stock' => array(
            'label' => __( 'Stock', 'atoz-woocommerce-product-importer' ),
            'mapping_hints' => array('qty', 'quantity')),
        '_stock_status' => array(
            'label' => __( 'Stock Status (Valid: instock/outofstock)', 'atoz-woocommerce-product-importer' ),
            'mapping_hints' => array('stock status', 'in stock')),
        '_backorders' => array(
            'label' => __( 'Backorders (Valid: yes/no/notify)', 'atoz-woocommerce-product-importer' ),
            'mapping_hints' => array('backorders')),
        '_manage_stock' => array(
            'label' => __( 'Manage Stock (Valid: yes/no)', 'atoz-woocommerce-product-importer' ),
            'mapping_hints' => array('manage stock')),
        'comment_status' => array(
            'label' => __( 'Comment/Review Status (Valid: open/closed)', 'atoz-woocommerce-product-importer' ),
            'mapping_hints' => array('comment status')),
        'ping_status' => array(
            'label' => __( 'Pingback/Trackback Status (Valid: open/closed)', 'atoz-woocommerce-product-importer' ),
        ...
        '_regular_price' => array(
            'label' => __( 'Regular Price', 'atoz-woocommerce-product-importer' ),
            'mapping_hints' => array('price', '_price', 'msrp')),
        '_sale_price' => array(
            'label' => __( 'Sale Price', 'atoz-woocommerce-product-importer' ),
            'mapping_hints' => array()),
        '_tax_status' => array(
            'label' => __( 'Tax Status (Valid: taxable/shipping/none)', 'atoz-woocommerce-product-importer' ),
            'mapping_hints' => array('tax status', 'taxable')),
        '_tax_class' => array(
            'label' => __( 'Tax Class', 'atoz-woocommerce-product-importer' ),
            'mapping_hints' => array()),
        'product_shipping_class_by_id' => array(
            'label' => __( 'Shipping Class By ID (Separated by "|")', 'atoz-woocommerce-product-importer' ),
            'mapping_hints' => array()),
        'product_shipping_class_by_name' => array(
            'label' => __( 'Shipping Class By Name (Separated by "|")', 'atoz-woocommerce-product-importer' ),
            'mapping_hints' => array('product_shipping_class', 'shipping_class', 'product shipping class', 'shipping class')),
        '_weight' => array(
            'label' => __( 'Weight', 'atoz-woocommerce-product-importer' ),
            'mapping_hints' => array('wt')),
        '_length' => array(
            'label' => __( 'Length', 'atoz-woocommerce-product-importer' ),
            'mapping_hints' => array('l')),
        '_width' => array(
            'label' => __( 'Width', 'atoz-woocommerce-product-importer' ),
            'mapping_hints' => array('w')),
        '_height' => array(
            'label' => __( 'Height', 'atoz-woocommerce-product-importer' ),
        ...
        '_downloadable' => array(
            'label' => __( 'Downloadable (Valid: yes/no)', 'atoz-woocommerce-product-importer' ),
            'mapping_hints' => array('downloadable')),
        '_virtual' => array(
            'label' => __( 'Virtual (Valid: yes/no)', 'atoz-woocommerce-product-importer' ),
            'mapping_hints' => array('virtual')),
        '_product_type' => array(
            'label' => __( 'Product Type (Valid: simple/variable/grouped/external)', 'atoz-woocommerce-product-importer' ),
            'mapping_hints' => array('product type', 'type')),
        '_button_text' => array(
            'label' => __( 'Button Text (External Product Only)', 'atoz-woocommerce-product-importer' ),
            'mapping_hints' => array('button text')),
        '_product_url' => array(
            'label' => __( 'Product URL (External Product Only)', 'atoz-woocommerce-product-importer' ),
            'mapping_hints' => array('product url', 'url')),
        '_file_paths' => array(
            'label' => __( 'File Path (Downloadable Product Only)', 'atoz-woocommerce-product-importer' ),
            'mapping_hints' => array('file path', 'file', 'file_path', 'file paths')),
        '_download_expiry' => array(
            'label' => __( 'Download Expiration (in Days)', 'atoz-woocommerce-product-importer' ),
            'mapping_hints' => array('download expiration', 'download expiry')),
        '_download_limit' => array(
            'label' => __( 'Download Limit (Number of Downloads)', 'atoz-woocommerce-product-importer' ),
        ...
        'product_cat_by_name' => array(
            'label' => __( 'Categories By Name (Separated by "|")', 'atoz-woocommerce-product-importer' ),
            'mapping_hints' => array('category', 'categories', 'product category', 'product categories', 'product_cat')),
        'product_cat_by_id' => array(
            'label' => __( 'Categories By ID (Separated by "|")', 'atoz-woocommerce-product-importer' ),
            'mapping_hints' => array()),
        'product_tag_by_name' => array(
            'label' => __( 'Tags By Name (Separated by "|")', 'atoz-woocommerce-product-importer' ),
            'mapping_hints' => array('tag', 'tags', 'product tag', 'product tags', 'product_tag')),
        'product_tag_by_id' => array(
            'label' => __( 'Tags By ID (Separated by "|")', 'atoz-woocommerce-product-importer' ),
            'mapping_hints' => array()),
        ...
        'custom_field' => array(
            'label' => __( 'Custom Field / Product Attribute (Set Name Below)', 'atoz-woocommerce-product-importer' ),
            'mapping_hints' => array('custom field', 'custom')),
        'post_meta' => array(
            'label' => __( 'Post Meta', 'atoz-woocommerce-product-importer' ),
        ...
        'product_image_by_url' => array(
            'label' => __( 'Images (By URL, Separated by "|")', 'atoz-woocommerce-product-importer' ),
        ...
        'product_image_by_path' => array(
            'label' => __( 'Images (By Local File Path, Separated by "|")', 'atoz-woocommerce-product-importer' ),
...
<div class="woo_product_importer_wrapper wrap">
    ...
    <h2><?php _e( 'Woo Product Importer &raquo; Preview', 'atoz-woocommerce-product-importer' ); ?></h2>
    ...
    <?php if($row_count > 0): ?>
        <form enctype="multipart/form-data" method="post" action="<?php echo get_admin_url().'tools.php?page=atoz-woocommerce-product-importer&action=result'; ?>">
            ...
            <p>
                <button class="button-primary" type="submit"><?php _e( 'Import', 'atoz-woocommerce-product-importer' ); ?></button>
            </p>
            ...
            <table id="import_data_preview" class="wp-list-table widefat fixed pages" cellspacing="0">
                <thead>
                    <?php if(intval($_POST['header_row']) == 1): ?>
                        <tr class="header_row">
                            <th colspan="<?php echo sizeof($header_row); ?>"><?php _e( 'CSV Header Row', 'atoz-woocommerce-product-importer' ); ?></th>
                        </tr>
                        <tr class="header_row">
                        ...
                        ?>
                            <th>
                                <div class="map_to_settings">
                                    <?php _e( 'Map to:', 'atoz-woocommerce-product-importer' ); ?> <select name="map_to[<?php echo $key; ?>]" class="map_to">
                                        <optgroup>
                                ...
                                <div class="custom_field_settings field_settings">
                                    <h4><?php _e( 'Custom Field Settings', 'atoz-woocommerce-product-importer' ); ?></h4>
                                    <p>
                                        <label for="custom_field_name_<?php echo $key; ?>"><?php _e( 'Name', 'atoz-woocommerce-product-importer' ); ?></label>
                                    ...
                                    <p>
                                        ...
                                        <label for="custom_field_visible_<?php echo $key; ?>"><?php _e( 'Visible?', 'atoz-woocommerce-product-importer' ); ?></label>
                                    </p>
                                </div>
                                <div class="product_image_settings field_settings">
                                    <h4><?php _e( 'Image Settings', 'atoz-woocommerce-product-importer' ); ?></h4>
                                    <p>
                                        ...
                                        <label for="product_image_set_featured_<?php echo $key; ?>"><?php _e( 'Set First Image as Featured', 'atoz-woocommerce-product-importer' ); ?></label>
                                    </p>
                                    <p>
                                        ...
                                        <label for="product_image_skip_duplicates_<?php echo $key; ?>"><?php _e( 'Skip Duplicate Images', 'atoz-woocommerce-product-importer' ); ?></label>
                                    </p>
                                </div>
                                <div class="post_meta_settings field_settings">
                                    <h4><?php _e( 'Post Meta Settings', 'atoz-woocommerce-product-importer' ); ?></h4>
                                    <p>
                                        <label for="post_meta_key_<?php echo $key; ?>"><?php _e( 'Meta Key', 'atoz-woocommerce-product-importer' ); ?></label>
